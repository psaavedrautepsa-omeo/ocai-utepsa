...
function App() {
  ...
  const publicaciones = [
    ...
    { titulo: "La IA según Harari, en Davos: el \"cuchillo que decide\" y el \"nuevo inmigrante\"", autores: "MSc. Juan Carlos Peña Gutiérrez", año: "2026", linea: "tecnologia", enlace: null, imagen: "https://images.unsplash.com/photo-1697577418970-95d99b5a55cf?auto=format&fit=crop&w=400&q=80", resumen: "Publicado en BarcelonaDot (23 de enero de 2026). Reflexión sobre las ideas de Yuval Noah Harari en Davos acerca de la inteligencia artificial y sus implicaciones geopolíticas." },
            ...
            <ScrollReveal animation="slideInLeft" delay={0}>
              <div>
                ...
                <div className="grid sm:grid-cols-3 gap-4 mb-8">
                  ...
                  <StatCounter target={7} label="Publicaciones" delay={200} />
